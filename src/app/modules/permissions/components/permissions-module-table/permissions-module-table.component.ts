...
@Component({
  selector: 'app-permissions-module-table',
  templateUrl: './permissions-module-table.component.html',
  styleUrls: ['./permissions-module-table.component.css'],
})
export class PermissionsModuleTableComponent implements OnInit {
  //variables
  @Input() data: any[] = [];
  @Input() dataKeys: any[] = [];
