...
@Component({
  selector: 'app-my-jobs-module-table',
  templateUrl: './my-jobs-module-table.component.html',
  styleUrls: ['./my-jobs-module-table.component.css'],
})
export class MyJobsModuleTableComponent implements OnInit {
  //variables
  @Input() data: any[] = [];
  @Input() dataKeys: any[] = [];
