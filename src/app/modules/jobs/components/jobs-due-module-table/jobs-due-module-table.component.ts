...
@Component({
  selector: 'app-jobs-due-module-table',
  templateUrl: './jobs-due-module-table.component.html',
  styleUrls: ['./jobs-due-module-table.component.css'],
})
export class JobsDueModuleTableComponent implements OnInit {
  //variables
  @Input() data: any[] = [];
  @Input() dataKeys: any[] = [];
