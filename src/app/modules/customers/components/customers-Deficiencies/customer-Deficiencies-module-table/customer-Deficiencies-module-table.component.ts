...
@Component({
  selector: 'app-customer-Deficiencies-module-table',
  templateUrl: './customer-Deficiencies-module-table.component.html',
  styleUrls: ['./customer-Deficiencies-module-table.component.css'],
})
export class CustomerDeficienciesModuleTableComponent implements OnInit {
  //variables
  @Input() data: any[] = [];
  @Input() dataKeys: any[] = [];
