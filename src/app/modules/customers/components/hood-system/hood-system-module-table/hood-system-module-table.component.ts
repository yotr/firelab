...
@Component({
  selector: 'app-hood-system-module-table',
  templateUrl: './hood-system-module-table.component.html',
  styleUrls: ['./hood-system-module-table.component.css'],
})
export class HoodSystemModuleTableComponent implements OnInit {
  //variables
  @Input() data: any[] = [];
  @Input() dataKeys: any[] = [];
