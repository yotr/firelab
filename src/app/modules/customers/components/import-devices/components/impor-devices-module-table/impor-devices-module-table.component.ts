...
@Component({
  selector: 'app-impor-devices-module-table',
  templateUrl: './impor-devices-module-table.component.html',
  styleUrls: ['./impor-devices-module-table.component.css'],
})
export class ImporDevicesModuleTableComponent implements OnInit {
  //variables
  @Input() data: any[] = [];
  @Input() dataKeys: any[] = [];
