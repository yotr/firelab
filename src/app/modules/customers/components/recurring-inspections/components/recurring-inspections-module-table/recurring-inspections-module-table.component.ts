...
@Component({
  selector: 'app-recurring-inspections-module-table',
  templateUrl: './recurring-inspections-module-table.component.html',
  styleUrls: ['./recurring-inspections-module-table.component.css'],
})
export class RecurringInspectionsModuleTableComponent implements OnInit {
  //variables
  @Input() data: any[] = [];
  @Input() dataKeys: any[] = [];
