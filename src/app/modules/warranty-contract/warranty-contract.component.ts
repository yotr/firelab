...
@Component({
  selector: 'app-warranty-contract',
  templateUrl: './warranty-contract.component.html',
  styleUrls: ['./warranty-contract.component.css'],
})
export class WarrantyContractComponent implements OnInit {
  // current language
  ...
  constructor(
    ...
    this.dataKeys = [
      {
        name: 'name',
        display: this.translateService.instant('warrantyContract.table.name'),
        type: 'string',
        active: true,
      },
      {
        name: 'date',
        display: this.translateService.instant('warrantyContract.table.date'),
        type: 'string',
        active: true,
      },
      {
        ...
        display: this.translateService.instant(
          'warrantyContract.table.customer'
        ),
        type: 'object',
        active: true,
      },
      {
        name: 'warranty',
        display: this.translateService.instant(
          'warrantyContract.table.template'
        ),
        type: 'object',
        active: true,
      },
      ...
      //   name: 'status',
      //   display: this.translateService.instant(
      //     'warrantyContract.table.tolerance'
      //   ),
      //   type: 'object',
      //   active: true,
      // },
    ...
    this.apiService
      ...
      .subscribe({
        next: (data: any) => {
          console.log(data);
          if (data?.isSuccess) {
            this.data = data?.value?.warrantyContracts;
  ...
  delete(deleteId: any) {
    ...
    this.apiService.delete('warrantyContract', deleteId).subscribe({
      next: (data) => {
        console.log(data);
        if (data?.isSuccess) {
