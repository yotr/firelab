...
@Component({
  selector: 'app-supplier-module-table',
  templateUrl: './supplier-module-table.component.html',
  styleUrls: ['./supplier-module-table.component.css'],
})
export class SupplierModuleTableComponent implements OnInit {
  //variables
  @Input() data: any[] = [];
  @Input() dataKeys: any[] = [];
