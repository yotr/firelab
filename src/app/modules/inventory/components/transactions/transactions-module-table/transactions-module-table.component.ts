...
@Component({
  selector: 'app-transactions-module-table',
  templateUrl: './transactions-module-table.component.html',
  styleUrls: ['./transactions-module-table.component.css'],
})
export class TransactionsModuleTableComponent implements OnInit {
  //variables
  @Input() data: any[] = [];
  @Input() dataKeys: any[] = [];
