...
@Component({
  selector: 'app-parts-module-table',
  templateUrl: './parts-module-table.component.html',
  styleUrls: ['./parts-module-table.component.css'],
})
export class PartsModuleTableComponent implements OnInit {
  //variables
  @Input() data: any[] = [];
  @Input() dataKeys: any[] = [];
