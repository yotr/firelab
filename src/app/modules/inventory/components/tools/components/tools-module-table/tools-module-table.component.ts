...
@Component({
  selector: 'app-tools-module-table',
  templateUrl: './tools-module-table.component.html',
  styleUrls: ['./tools-module-table.component.css'],
})
export class ToolsModuleTableComponent implements OnInit {
  //variables
  @Input() data: any[] = [];
  @Input() dataKeys: any[] = [];
