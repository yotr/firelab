...
@Component({
  selector: 'app-company-module-table',
  templateUrl: './company-module-table.component.html',
  styleUrls: ['./company-module-table.component.css'],
})
export class CompanyModuleTableComponent implements OnInit {
 //variables
  @Input() data: any[] = [];
  @Input() dataKeys: any[] = [];
