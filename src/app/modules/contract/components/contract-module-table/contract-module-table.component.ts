...
@Component({
  selector: 'app-contract-module-table',
  templateUrl: './contract-module-table.component.html',
  styleUrls: ['./contract-module-table.component.css'],
})
export class ContractModuleTableComponent implements OnInit {
  //variables
  @Input() data: any[] = [];
  @Input() dataKeys: any[] = [];
