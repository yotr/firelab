...
@Component({
  selector: 'app-time-card-module-table',
  templateUrl: './time-card-module-table.component.html',
  styleUrls: ['./time-card-module-table.component.css'],
})
export class TimeCardModuleTableComponent implements OnInit {
  //variables
  @Input() data: any[] = [];
  @Input() dataKeys: any[] = [];
